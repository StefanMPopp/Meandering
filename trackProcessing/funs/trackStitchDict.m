function stitch = trackStitchDict(NEraw, NWraw, SEraw, SWraw, params)
...
load('lensParams.mat') % gets camera params from cameraCalib
...
% Combine
disp('8/8: Combining')
stitch = [NEshift; NWshift; SEshift; SWshift];
